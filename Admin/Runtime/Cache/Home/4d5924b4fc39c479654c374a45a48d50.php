...
<body>
<div class="pd-20">
	<form action="<?php echo U('User/UserAdd');?>" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="password" name="repassword" placeholder="再次输入密码" autocomplete="off" value="" class="input-text" datatype="*6-20" nullmsg="密码不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<textarea name="info" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)"></textarea>
