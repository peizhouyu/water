...
<body>
<div class="pd-20">
	<form action="<?php echo U('WebsiteBusiness/BusinessAddSelect');?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<label class="form-label col-1"><span class="c-red">*</span>地点：</label>
			<div class="formControls col-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="location">
			</div>
		</div>
		<div class="row cl">
