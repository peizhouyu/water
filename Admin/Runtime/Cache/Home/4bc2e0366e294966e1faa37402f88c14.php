...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 幻灯管理 <span class="c-gray en">&gt;</span> 幻灯列表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="text-c"> 
		<span class="select-box inline">
				<select name="" class="select">
					<option value="0">全部幻灯</option>
					<option value="1">|-栏目一</option>
					<option value="2">|-栏目二</option>
				</select>
		</span>
		<input type="text" name="" id="" placeholder=" 幻灯名称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜幻灯</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius"  href="<?php echo U('Banner/bannerAdd');?>"><i class="Hui-iconfont">&#xe600;</i> 添加幻灯</a></span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td class="text-l"><b><?php echo ($vo["secondtitle"]); ?></b></td>
					
					<td><?php echo ($vo["dump_url"]); ?></td>
					<td class="td-status"><span class="label label-success radius"><?php echo ($vo["time"]); ?></span></td>
					<td class="td-status"><span class="label label-success radius"><?php echo ($vo["valid"]); ?></span></td>
					<td class="f-14 td-manage">
						 <a style="text-decoration:none" class="ml-5"  href="<?php echo U('Banner/bannerCheck',array('id'=>$vo['id']));?>" title="是否有效"><i class="Hui-iconfont">&#xe603;</i></a>
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('Banner/bannerChange',array('id'=>$vo['id']));?>" title="修改幻灯"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('Banner/bannerDel',array('id'=>$vo['id']));?>" title="删除幻灯"><i class="Hui-iconfont">&#xe6e2;</i></a>
						<!-- <a style="text-decoration:none" class="ml-5" href="javascript:;" title="置顶幻灯"><i class="Hui-iconfont">&#xe684;</i></a> -->
					</td>
