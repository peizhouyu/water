...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 站内业务 <span class="c-gray en">&gt;</span> 站内业务列表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="text-c">
		<form action="<?php echo U('WebsiteBusiness/BusinessShowList');?>" method="get" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius"  href="<?php echo U('WebsiteBusiness/BusinessAddSelect');?>"><i class="Hui-iconfont">&#xe600;</i> 信息发布</a></span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td class="td-status"><span class="label label-success radius"><?php echo ($vo["type_value"]); ?></span></td>
					<td class="f-14 td-manage">
						...
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('WebsiteBusiness/BusinessChange',array('type'=>$vo['type'],'id'=>$vo['id']));?>" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('WebsiteBusiness/BusinessDel',array('type'=>$vo['type'],'id'=>$vo['id']));?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="r"><?php echo ($page); ?>11</span>
	</div>
</div>
