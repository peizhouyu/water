...
<div class="pd-20">
	<div class="text-c">
		<form action="<?php echo U('Policies/policiesShowList');?>" method="get" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius"  href="<?php echo U('Policies/policiesAddSelect');?>"><i class="Hui-iconfont">&#xe600;</i> 信息发布</a></span>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td class="f-14 td-manage">
						...
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('Policies/policiesChange',array('type'=>$vo['type'],'id'=>$vo['id']));?>" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5"  href="<?php echo U('Policies/policiesDel',array('type'=>$vo['type'],'id'=>$vo['id']));?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
