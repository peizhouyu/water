...
<body>
<div class="pd-20">
	<form action="<?php echo U('ProductShow/ProductShowAddSelect');?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>产品公司：</label>
			<div class="formControls col-4">
			...
			<div class="formControls col-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="company_tel">
			</div>
		</div>
		<div class="row cl">
