...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/develop/water/Public/assets/css/product.css" />
		<link rel="stylesheet" type="text/css" href="/develop/water/Public/assets/css/leftNav.css" />
		<!-- pagination style -->
	...
	<body>
		...
		<header data-am-widget="header" class="listStatus am-header am-header-default">
			...
			<div class="am-header-right am-header-nav">
				<a href="#right-link" class="am-show-md-down am-hide-sm">
		...
		<div class="clearfix"></div>
		<!--  subNav 副导航－移动端 Start -->
		<nav data-am-widget="menu" class="am-menu  am-menu-slide1 am-hide-lg am-hide-md" data-am-menu-collapse id="mobile-subNav">
			<a href="javascript: void(0)" class="am-menu-toggle">
				<i class="am-menu-toggle-icon am-icon-th-large"></i>
			</a>
			<ul class="am-menu-nav am-avg-sm-3 am-collapse">
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=0');?>" class="">防震减灾</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=1');?>" class="">农田水利</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=2');?>" class="">水利工程</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=3');?>" class="">农村安全饮水</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=4');?>" class="">水资源开发与节约保护</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=5');?>" class="">水生态与水环境</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=6');?>" class="">水利信息化</a>
				</li>
				<li class="sub-align">
					<a href="<?php echo U('Index/NavSelect?aim=zhanshi&id=7');?>" class="">水利管理与其他</a>
				</li>
			</ul>
		</nav>
		<!--  subNav 副导航－移动端 End -->
		...
		<div class="list">
			...
			<div class="listNews">
				<div class="am-g am-g-fixed proShow-con">
					<ul data-am-widget="gallery" class="am-gallery am-gallery-default am-g" data-am-gallery="{ }">
						<li class="am-u-lg-3 am-u-md-4 listNewsNav am-hide-sm">
						...
						<li class="productListRight am-u-lg-9 am-u-md-8 am-u-sm-12">
							<ul class="am-g">
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="am-u-lg-4 am-u-md-6">
									<a href="<?php echo U('Content/showPage',array('aim'=>$vo['aim'],'id'=>$vo['id']));?>" class="productListImg"><img src="<?php echo ($vo["img_url"]); ?>" /></a>
									<div class="productListCard">
										<a href="<?php echo U('Content/showPage',array('aim'=>$vo['aim'],'id'=>$vo['id']));?>">
											<p class="mainTitle"><?php echo ($vo["title"]); ?></p>
											<p class="subTitle"><?php echo ($vo["info"]); ?></p>
											<p class="company"><span class="iconfont">&#xe60e;</span><?php echo ($vo["company"]); ?></p>
											<p class="subCompany">数据</p>
											<p class="telephone"><span class="iconfont">&#xe60c;</span><?php echo ($vo["company_tel"]); ?></p>
										</a>
									</div>
