...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/develop/water/Public/assets/css/communicate.css" />
		<!-- pagination style -->
	...
	<body>
		...
		<div class="list">
			...
			<div class="listNews">
				...
				<ul class="am-g am-g-fixed am-avg-lg-4 am-avg-md-3 am-avg-sm-2 am-avg-xs-2">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-padding-horizontal-xs">
						<div class="list-card" id="listCard">
							<a class="list-img" href="<?php echo U('Content/showPage',array('aim'=>$vo['aim'],'id'=>$vo['id']));?>">
								<img src="<?php echo ($vo["himg_url"]); ?>">
							</a>
							<a href="<?php echo U('Content/showPage',array('aim'=>$vo['aim'],'id'=>$vo['id']));?>" class="list-label"><?php echo ($data["name2"]); ?></a>
							<div class="list-tit">
								...
								<p class="am-fr"><i class="iconfont">&#xe60d;</i>凯通大厦</p>
