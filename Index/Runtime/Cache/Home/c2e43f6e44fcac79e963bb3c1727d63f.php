			...
			<div class="listNews">
				...
				<div class="am-g am-g-fixed">
					<ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1">
						<li class="list-padding-horizontal-xs am-show-md-up am-u-lg-push-8 am-u-md-push-6">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-padding-horizontal-xs am-u-lg-pull-4 am-u-md-pull-6">

							<div class="list-card waterCard" id="listCard">
								<a class="list-img" href="<?php echo U('Content/showPage',array('aim'=>$vo['aim'],'id'=>$vo['id']));?>"><img src="<?php echo ($vo["img_url"]); ?>"></a>
								<div class="list-tit">
									...
									<p class="am-fr">
										<a href=""><i class="iconfont">&#xe61c;</i><?php echo ($vo["likenum"]); ?></a> |
										<a href="#"><i class="iconfont">&#xe61a;</i> <?php echo ($vo["readnum"]); ?></a>
									</p>
									<div class="clearfix"></div>
								</div>
							</div>
