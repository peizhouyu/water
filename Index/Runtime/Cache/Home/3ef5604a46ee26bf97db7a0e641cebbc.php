  ...
  <![endif]-->
	...
	<body>
		...
		<header data-am-widget="header" class="listStatus am-header am-header-default">
			...
			<h1 class="am-header-title"><?php echo ($data["name1"]); ?></h1>
			...
			<div class="listNews">
				...
				<div class="am-g am-g-fixed">
					<ul class="am-avg-lg-4 am-avg-md-2 am-avg-sm-1">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="am-u-lg-3">
